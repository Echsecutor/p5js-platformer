function PhysicalObject() {
  ...
  this.collides_with = function(physicalObject) {
    return (Math.abs(this.position.x - physicalObject.position.x) < this.size.x + physicalObject.size.x &&
      Math.abs(this.position.y - physicalObject.position.y) < this.size.y + physicalObject.size.y)
  }
